package cc.wechat.constant;

/**
 * Menu 常量
 * @author weny
 * @datetime 2015年12月7日 上午9:33:19
 */
public interface MenuConstant {
	
	public static final String MENU_TEXT_FUNC_JOKE = "menu.text.func.joke";
	public static final String MENU_TEXT_FUNC_WEATHER = "menu.text.func.weather";
