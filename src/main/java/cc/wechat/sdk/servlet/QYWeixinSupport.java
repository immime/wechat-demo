...
import cc.wechat.sdk.company.handle.QYEventHandle;
import cc.wechat.sdk.company.handle.QYMessageHandle;
import cc.wechat.sdk.company.message.req.QYBaseEvent;
import cc.wechat.sdk.company.message.req.QYBaseReq;
import cc.wechat.sdk.company.message.req.QYBaseReqMsg;
import cc.wechat.sdk.company.message.req.QYBatchJobEvent;
import cc.wechat.sdk.company.message.req.QYEnterAgentEvent;
import cc.wechat.sdk.company.message.req.QYEventType;
import cc.wechat.sdk.company.message.req.QYImageReqMsg;
import cc.wechat.sdk.company.message.req.QYLocationEvent;
import cc.wechat.sdk.company.message.req.QYLocationReqMsg;
import cc.wechat.sdk.company.message.req.QYMenuEvent;
import cc.wechat.sdk.company.message.req.QYReqType;
import cc.wechat.sdk.company.message.req.QYScanCodeEvent;
import cc.wechat.sdk.company.message.req.QYSendPicInfoEvent;
import cc.wechat.sdk.company.message.req.QYTextReqMsg;
import cc.wechat.sdk.company.message.req.QYVideoReqMsg;
import cc.wechat.sdk.company.message.req.QYVoiceReqMsg;
import cc.wechat.sdk.company.message.resp.QYBaseRespMsg;
