package cc.wechat.sdk.mp.util.xml;
...
import cc.wechat.sdk.mp.bean.WxMpXmlOutMusicMessage;
import cc.wechat.sdk.mp.bean.WxMpXmlOutNewsMessage;
import cc.wechat.sdk.mp.bean.WxMpXmlOutTextMessage;
import cc.wechat.sdk.mp.bean.WxMpXmlOutVideoMessage;
...
public class XStreamTransformer {
  ...
  @SuppressWarnings("unchecked")
  public static <T> T fromInputStream(Class<T> clazz, InputStream is) {
