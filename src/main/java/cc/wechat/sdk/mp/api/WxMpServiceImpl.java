...
import cc.wechat.sdk.common.bean.WxJsapiSignature;
...
import cc.wechat.sdk.common.session.StandardSessionManager;
import cc.wechat.sdk.common.session.WxSessionManager;
import cc.wechat.sdk.common.util.RandomUtils;
import cc.wechat.sdk.common.util.crypto.SHA1;
import cc.wechat.sdk.common.util.crypto.WxCryptUtil;
import cc.wechat.sdk.common.util.fs.FileUtils;
import cc.wechat.sdk.common.util.http.MediaDownloadRequestExecutor;
import cc.wechat.sdk.common.util.http.MediaUploadRequestExecutor;
import cc.wechat.sdk.common.util.http.RequestExecutor;
import cc.wechat.sdk.common.util.http.SimpleGetRequestExecutor;
import cc.wechat.sdk.common.util.http.SimplePostRequestExecutor;
import cc.wechat.sdk.common.util.http.URIUtil;
import cc.wechat.sdk.common.util.http.Utf8ResponseHandler;
import cc.wechat.sdk.common.util.json.GsonHelper;
import cc.wechat.sdk.common.util.xml.XStreamInitializer;
...
import cc.wechat.sdk.mp.bean.WxMpSemanticQuery;
...
import cc.wechat.sdk.mp.bean.result.WxMpPrepayIdResult;
...
import cc.wechat.sdk.mp.util.http.QrCodeRequestExecutor;
