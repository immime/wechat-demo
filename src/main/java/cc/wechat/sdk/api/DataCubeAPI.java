...
import cc.wechat.sdk.api.response.GetArticleSummaryResponse;
import cc.wechat.sdk.api.response.GetArticleTotalResponse;
import cc.wechat.sdk.api.response.GetInterfaceSummaryHourResponse;
import cc.wechat.sdk.api.response.GetInterfaceSummaryResponse;
import cc.wechat.sdk.api.response.GetUpstreamMsgDistMonthResponse;
import cc.wechat.sdk.api.response.GetUpstreamMsgDistResponse;
import cc.wechat.sdk.api.response.GetUpstreamMsgDistWeekResponse;
import cc.wechat.sdk.api.response.GetUpstreamMsgHourResponse;
import cc.wechat.sdk.api.response.GetUpstreamMsgMonthResponse;
import cc.wechat.sdk.api.response.GetUpstreamMsgResponse;
import cc.wechat.sdk.api.response.GetUpstreamMsgWeekResponse;
import cc.wechat.sdk.api.response.GetUserCumulateResponse;
import cc.wechat.sdk.api.response.GetUserReadHourResponse;
import cc.wechat.sdk.api.response.GetUserReadResponse;
