package cc.wechat.sdk.company.api.config;
...
import cc.wechat.sdk.api.config.ChangeType;
import cc.wechat.sdk.api.config.ConfigChangeNotice;
import cc.wechat.sdk.api.response.GetJsApiTicketResponse;
import cc.wechat.sdk.api.response.GetTokenResponse;
